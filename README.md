...
```bash
docker build --platform linux/amd64 --file Dockerfile --tag analytical-platform.service.justice.gov.uk/mlflow:local .
```
...
docker run -it --rm \
  ...
  analytical-platform.service.justice.gov.uk/mlflow:local
```
